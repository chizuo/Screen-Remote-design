namespace ScreenRemote
{
    internal class Program
    {
        static void Main(string[] args)
        {
             ...
             ********************************************/
            var TU7000 = new Dictionary<string, long>() {
                {"UN75",887276400082},
                {"UN70",887276400075},
                {"UN65",887276400068},
                {"UN58",887276400051},
            ...
            var ScreenRemotes = new Dictionary<Remote, Screen>();

            //string key = ModelInput(TU7000);
            string key = "UN75";
            Screen screen = ModelScreen(key, TU7000);
        ...
        static public SignalHandler Pairing(Screen screen, string model)
        {
        ...
        static public Screen ModelScreen(string key, Dictionary<string, long> TU7000)
        {
            if (key.Equals("UN75")) { return new UN75(TU7000[key], key); }
            ...
            return new Screen(0000000000, "Demo");
        }
