...
namespace ScreenRemote
{
    public class Screen : TM124A
    {
        ...
        public Screen(long upc, string name)
        {
            upcNumber = upc;
        ...
        public virtual void Menu(string command)
        {
            ...
            {
                Console.WriteLine("Menu for {0}", this.upcNumber);
            }
        }
        ...
        public virtual void Settings(string command)
        {
            ...
            {
                Console.WriteLine("Settings for {0}", this.upcNumber);
            }
        }
